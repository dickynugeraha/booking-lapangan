...
<body class="text-center"  style="width: 30rem; margin:auto;">
    ...
    <main class="form-signin">
        <form action="" method="POST">
            ...
            <img class="mb-3" src="assets/img/logo.jpg" alt="" width="130" height="130" style="border-radius: 50%">
           
            <h1 class="h3 mb-4 fw-normal"> <b>Admin Login</b><i class="fas fa-key" style="margin-left: 10px;"></i></h1>
